...
function Modal() {
    ...
    return (
        <Transition.Root show={open} as={Fragment}>
            <Dialog
                as='div'
                className='fixed inset-0 z-10 overscroll-y-auto'
                onClose={setOpen}
            >
                            ...
                            <div>
                                {selectedFile ? (
                                    ...
                                    <div
                                        ...
                                        className='mx-auto flex items-center justify-center h-12  w-12 rounded-full bg-gonza-violet-300 cursor-pointer'
                                    >
                                        <CameraIcon
                                ...
                                <div className='mt-5 sm:mt-6'>
                                    <button
                                        ...
                                        className='inline-flex justify-center w-full rounded-md border border-transparent shadow-sm px-4 py-2 bg-gonza-violet-600 text-base font-medium text-white hover:bg-gonza-violet-800 focus:outline-none focus-ring-2 focus:ring-offset-2 focus:ring-red-500 sm:text-sm disabled:bg-gray-300 disabled:cursor-not-allowed hover:disabled:bg-gray-300'
                                        onClick={uploadoPost}
                                    >
